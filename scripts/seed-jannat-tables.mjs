#!/usr/bin/env node
/**
 * Seed les 66 tables Jannat Bloudan via l'API admin (nécessite session ADMIN).
...
console.log("Pour charger les 66 tables Jannat Bloudan, exécutez :")
...
console.log("  https://jannat-bloudan.vercel.app/table/T41/menu")
console.log("  https://jannat-bloudan.vercel.app/table/N15/menu")

try {
  const sql = readFileSync(sqlPath, "utf8")
  const count = (sql.match(/INSERT INTO restaurant_tables/g) || []).length
  console.log(`\nFichier SQL prêt (${count > 0 ? "66 tables" : "généré"}).`)
} catch (e) {

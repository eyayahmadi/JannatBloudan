#!/usr/bin/env node
/**
 * Upload Page 3 Hauptgerichte Menü images → Supabase Storage
 * Sets image_url ONLY when missing or placeholder.
 *
 * Usage:
 *   node --env-file=.env.local scripts/assign-menu-page-3-images.mjs
 *
 * Expects PNG sources in data/menu-images/plats/{slug}.png
 */
...
const NEW_SLUGS = [
  ...
  "cordon-blue",
  "fajita-polo",
  "mandi-mit-lammfleisch",
  "jordanisches-mansaf",
  "crispy-shrimps",
  "haehnchenspiesse-im-tontopf",
  "hackfleisch-im-tontopf",
]
...
console.log("🍽️  Menu Page 3 — upload images (new products only)\n")

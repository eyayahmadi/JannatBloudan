#!/usr/bin/env node
/**
 * Upload Page 9 drink images → Supabase Storage
 * Sets image_url ONLY when missing or placeholder (new products only).
 *
 * Usage:
 *   node --env-file=.env.local scripts/assign-menu-page-9-images.mjs
 */
...
const PRODUCTS = [
  { slug: "kaffee-milkshake", folder: "milkshakes" },
  { slug: "lotus-milkshake", folder: "milkshakes" },
]
...
console.log("🥤  Menu Page 9 — images (new products only)\n")
let ok = 0
let skipped = 0

#!/usr/bin/env node
/**
 * Upload Page 2 menu product images → Supabase Storage
 * Sets image_url ONLY when missing or placeholder (never overwrites existing photos).
 *
 * Usage:
 *   node --env-file=.env.local scripts/assign-menu-page-2-images.mjs
 *
 * Expects PNG sources in:
 *   data/menu-images/kleine-gerichte/{slug}.png
 *   data/menu-images/saj-rolle/{slug}.png
 */
...
const PRODUCTS = [
  { slug: "rizo", folder: "kleine-gerichte" },
  { slug: "sauercreme-kumpir", folder: "kleine-gerichte" },
  { slug: "aioli-kumpir", folder: "kleine-gerichte" },
  { slug: "guacamole-kumpir", folder: "kleine-gerichte" },
  { slug: "hackfleisch-knoblauch-rolle", folder: "saj-rolle" },
  { slug: "haehnchenspiess-rolle", folder: "saj-rolle" },
  { slug: "burger-rolle", folder: "saj-rolle" },
  { slug: "lammfleisch-rolle", folder: "saj-rolle" },
]
...
console.log("🍽️  Menu Page 2 — upload images (new products only)\n")
...
console.log(`\nTerminé: ${ok} upload(s), ${skipped} conservé(s), ${PRODUCTS.length - ok - skipped} en attente.`)

#!/usr/bin/env node
/**
 * Upload Page 4 Grillgerichte images → Supabase Storage
 * Sets image_url ONLY when missing or placeholder.
 *
 * Usage:
 *   node --env-file=.env.local scripts/assign-menu-page-4-images.mjs
 */
...
const FOLDER = "grillades"
const SIZE = 1200

const NEW_SLUGS = ["lamm-1kg", "ganzes-grillhaehnchen"]
...
console.log("🔥  Menu Page 4 — upload images (new products only)\n")

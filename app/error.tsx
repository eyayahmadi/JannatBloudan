    ...
    <PageShell>
      ...
      <main className="relative flex flex-1 items-center justify-center overflow-hidden px-4 py-16 sm:py-24">
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(ellipse 50% 40% at 30% 30%, rgba(220, 38, 38, 0.12) 0%, transparent 60%),
        ...
        <div className="relative z-[1] mx-auto w-full max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-lg text-base text-amber-900/80 sm:text-lg">
            Nous avons rencontré un problème inattendu. Vous pouvez réessayer, retourner
            à l&apos;accueil, ou nous contacter si le problème persiste.
          </p>

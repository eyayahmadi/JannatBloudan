...
export const MENU_PRODUCT_ATTRIBUTES: MenuProductAttributeDef[] = [
  ...
  { id: "featured", labelDe: "Featured", labelAr: "مميز", group: "badge" },
  { id: "today_recommended", labelDe: "Heute empfohlen", labelAr: "موصى به اليوم", group: "badge" },
  { id: "seasonal", labelDe: "Saisonal", labelAr: "موسمي", group: "badge" },
  { id: "promotion", labelDe: "Promotion", labelAr: "عرض", group: "badge" },
...
export const ATTRIBUTE_BADGE_STYLES: Record<string, string> = {
  ...
  featured: "bg-amber-600/25 text-amber-950 dark:bg-amber-900/40 dark:text-amber-100",
  today_recommended: "bg-orange-500/25 text-orange-950 dark:bg-orange-900/35 dark:text-orange-100",
  seasonal: "bg-emerald-600/20 text-emerald-950 dark:bg-emerald-900/30 dark:text-emerald-100",
  promotion: "bg-rose-500/20 text-rose-950 dark:bg-rose-900/30 dark:text-rose-100",

...
export const ADMIN_PORTAL_NAV: AdminPortalNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "menu-products", label: "Produkte", href: "/admin/menu/products", icon: Package, matchPrefix: true },
      { id: "menu-categories", label: "Kategorien", href: "/admin/menu/categories", icon: FolderTree, matchPrefix: true },
      { id: "menu-extras", label: "Extras", href: "/admin/menu/extras", icon: Sparkles, matchPrefix: true },
      { id: "menu-variants", label: "Varianten", href: "/admin/menu/variants", icon: Tag, matchPrefix: true },
      { id: "menu-recos", label: "Empfehlungen", href: "/admin/menu/recommendations", icon: Lightbulb, matchPrefix: true },

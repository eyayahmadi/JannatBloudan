...
export const ADMIN_PORTAL_NAV: AdminPortalNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { id: "menu", label: "Gestion du menu", href: "/admin/menu", icon: UtensilsCrossed, matchPrefix: true },
      { id: "categories", label: "Catégories", href: "/admin/menu", icon: FolderTree },
      { id: "products", label: "Produits", href: "/admin/menu", icon: Package },
